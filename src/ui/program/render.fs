module Aornota.Sweepstake2023.Ui.Program.Render
...
open Aornota.Sweepstake2023.Ui.Common.Render.Markdown
open Aornota.Sweepstake2023.Ui.Common.TimestampHelper
open Aornota.Sweepstake2023.Ui.Pages
open Aornota.Sweepstake2023.Ui.Program.Common
open Aornota.Sweepstake2023.Ui.Program.Markdown.Literals
...
open Aornota.Sweepstake2023.Common.Domain.User // note: after Aornota.Sweepstake2023.Ui.Render.Bulma to avoid collision with Icon.Password
...
let private renderHeader (useDefaultTheme, navbarBurgerIsActive, serverStarted:DateTimeOffset option, headerStatus, headerPages, _:int<tick>) dispatch =
    ...
    let serverStarted =
        ...
        | SignedIn authUser, Some serverStarted when authUser.UserType = SuperUser ->
            let timestampText = ago serverStarted.LocalDateTime
    ...
    navbar theme navbarData [
        container (Fluid |> Some) [
            navbarBrand [
                yield navbarItem [ image "sweepstake-2023-24x24.png" (FixedSize Square24 |> Some) ]
                yield navbarItem [ [ str SWEEPSTAKE_2023 ] |> para theme { paraCentredSmallest with ParaColour = SemanticPara Black ; Weight = Bold } ]
    ...
    div divDefault [
        ...
        | AuthPage UserAdminPage ->
            ...
            | None ->
                ...
                yield lazyViewOrHMR renderSpecialNotificationMessage (useDefaultTheme, SWEEPSTAKE_2023, message, ticks)
...
let private renderFooter useDefaultTheme =
    ...
    footer theme true [
        container (Fluid |> Some) [
            [
                [ str "Written" ] |> link theme (NewWindow "https://github.com/aornota/sweepstake-2023") ; str " in "
...
let render state dispatch =
    div divDefault [
        ...
        | None -> ()
        yield lazyViewOrHMR2 renderNotificationMessages (state.UseDefaultTheme, SWEEPSTAKE_2023, state.NotificationMessages, state.Ticks) (DismissNotificationMessage >> dispatch)
