module Aornota.Sweepstake2023.Server.Common.JsonConverter
...
// Note: toJson/fromJson differ from Aornota.Sweepstake2023.Ui.Common.JsonConverter; see notes for Ui versions for details.
